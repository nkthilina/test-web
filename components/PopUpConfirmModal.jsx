...
function PopUpConfirmModal({ visible, onClose,  deleteFunction }) {
          ...
          <div className="w-full  max-w-xl p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            <div >
              ...
              <div className="p-3  mt-2 text-center space-x-4 md:block">
                <button onClick={deleteFunction} className="mb-2 md:mb-0 bg-primary border border-primary px-5 py-2 text-sm  shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-primary">Okay</button>
